...
void UzytkownikMenadzer::rejestracjaUzytkownika() //typ zwracanych danych, nazwa klasy :: nazwa metody
{
    Uzytkownik uzytkownik = podajDaneNowegoUzytkownika();

    uzytkownicy.push_back(uzytkownik);
    //PlikZUzytkownikami plikZUzytkownikami; //tworzymy obiekt plikZUz, bo chcemy uzyc metody ktora jest w klasie PlikZUz
    plikZUzytkownikami.dopiszUzytkownikaDoPliku(uzytkownik); //obiekt.metoda, bo metoda pochodzi z innej klasy
...
Uzytkownik UzytkownikMenadzer::podajDaneNowegoUzytkownika()//vector nie bedzie atrybutem - usuwamy bo jest zadeklarowany w pliku h
{
